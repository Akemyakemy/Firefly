...
export const site = {
  name: "versus0",
  desc: "技术+算法blog",
  url: "https://blog.542000.xyz",
  avatar: "https://img.542000.xyz/file/friend_avatar/1778931720838_f167cb95af9d881f4378b92b3e181d89_4647054993754934443.jpg",
  email: "AkemyHomura@hotmail.com",
  gravatar: "https://gravatar.com/futuristicallycycleefacb190c5?utm_source=hovercard",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-2.5 flex-1">
          {[
            ...
            { label: "个人名片（魔法⭐）", value: site.gravatar },
          ].map((item) => (
